...
public class Fragment_Adapter_BBB extends RecyclerView.Adapter<Fragment_Adapter_BBB.ViewHolder> {
    private final FragmentActivity activity;
    private final ArrayList<FuLiBean.ResultsBean> list;

    public Fragment_Adapter_BBB(final FragmentActivity activity, final ArrayList<FuLiBean.ResultsBean> list) {
